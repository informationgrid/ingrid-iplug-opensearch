...
<body onLoad="setListener()">
    ...
    <div id="contentBox" class="contentMiddle">
        ...
        <div class="controls">
            <a href="../base/extras.html">Zur�ck</a>
                ...
                <table id="konfigForm">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            Verf�gbare Platzhalter sind {searchTerms}, {geo:box}, {startPage}, {count}, {ingridsearch:xml},
                    ...
                    <tr>
                        <td colspan="2">
                            Weitere M�glichkeiten zur Manipulation des ranking score bestehen in der Aktivierung zus�tzlicher RankingModifier in der Datei ./webapp/WEB-INF/spring.xml
                        </td>
                    </tr>
                </table>
            </form:form>
